...
questions_data = [
    ...
    {"text": "周りの人からは、活発で社交的なタイプだと思われることが多い", "axis": "Mind", "weight": 1},
    ...
    {"text": "思ったことをストレートに言うよりも、配慮を優先する", "axis": "Nature", "weight": 1},
    ...
    {"text": "多少人の気持ちを害してでも、効率や合理性を優先する", "axis": "Nature", "weight": -1},
    ...
    {"text": "生活空間や仕事環境は、常に整理整頓されている", "axis": "Tactics", "weight": 1},
    ...
    {"text": "毎日決まったスケジュール通りに行動するのは苦手だ", "axis": "Tactics", "weight": -1},
    ...
    {"text": "「自分には能力がないのでは」と深く落ちこんでしまうことがある", "axis": "Identity", "weight": -1},
